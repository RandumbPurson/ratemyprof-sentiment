"""
Code from https://github.com/Rodantny/Rate-My-Professor-Scraper-and-Search/blob/master/RMPClass.py

Used and edited following guidelines of the MIT License
"""
